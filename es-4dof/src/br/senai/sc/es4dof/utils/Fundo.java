...
public class Fundo extends javax.swing.JPanel {
	...
	public Fundo() {
		try {
			...
			// que vai se repetir ao longo do fundo, o tamanho é você quem
			// escolhe.
//			rect = new Rectangle(0, 0, 130, 130);
	...
	public void paintComponent(Graphics g) {
		/*
		 * Se você quiser que a imagem seja uma só (extendida ao tamanho da
		 * tela, não replicada tire os comentários da proxima linha
		 */
